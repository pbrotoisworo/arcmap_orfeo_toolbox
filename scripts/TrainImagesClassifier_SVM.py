...
with open(log_file, 'w') as f:
    ...
    f.write('\nSVM Kernel Type: {}'.format(input_kernel_type))
    f.write('\nSVM Model Type: {}'.format(input_svm_model_type))
    f.write('\nCost Parameter C: {}'.format(input_cost_param_c))
    f.write('\nCost Parameter Nu: {}'.format(input_cost_param_nu))
    f.write('\nParameters Optimization: {}'.format(input_parameter_optimization))
    f.write('\nProbability Estimation: {}'.format(input_probability_estimation))
